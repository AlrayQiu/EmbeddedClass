...
/**************** System Register ****************/
#define SYS_CONFIG_ADDR                                                        \
  (0x00) // System Configuration, Default:0x00,Bits[2:0],System Mode
#define SYS_ALS_ACT (0x03)   // 0x01: ALS IR function active
...
#define PS_DATA_LOW (0x0E)   // Bits[7:0](RO) ALS lower byte of ADC OUTPUT
#define PS_DATA_HIGH (0x0F)  // Bits[7:0](RO) ALS Higher byte of ADC OUTPUT
...
extern uint16_t AP3216_Read_IR_Data();
